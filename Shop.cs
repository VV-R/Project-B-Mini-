public class Shop {
    ...
    private void Purchase(int index, CountedItem countedItem, Player player, int price) {
        ...
        Console.WriteLine($"Are you sure you want to buy {countedItem.Quantity} {countedItem.TheItem.NamePlural} for {countedItem.Quantity * price}? (y/n)");
        while (true) {
    ...
    public void browse(Player player) {
        ...
        while (true) {
            ...
            Console.WriteLine("Please enter which item you'd like to buy:");
